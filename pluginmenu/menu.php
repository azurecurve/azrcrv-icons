 ...
 *
 */
if (!function_exists('azrcrv_create_plugin_menu_i')){
	function azrcrv_create_plugin_menu_i(){
		azrcrv_create_plugin_menu_table_i();
		azrcrv_populate_plugin_menu_table_i();
	}
}
 ...
 *
 */
if (!function_exists('azrcrv_populate_plugin_menu_table_i')){
	function azrcrv_populate_plugin_menu_table_i(){
		global $wpdb;
 ...
 *
 */
if (!function_exists('azrcrv_create_plugin_menu_table_i')){
	function azrcrv_create_plugin_menu_table_i(){
		global $wpdb;
		$table_name = $wpdb->base_prefix.'azrcrv_plugin_menu';
