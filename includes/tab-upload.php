...
$file_format_warning_th = sprintf( esc_html__( 'Upload files must have an extension of %s', 'azrcrv-i' ), '<strong>png</strong>' );
$file_upload_th         = esc_html__( 'Select image to upload:', 'azrcrv-i' );
$file_upload_td         = "<input type='file' name='fileToUpload' id='fileToUpload'>";

if ( isset( $saved_options ) ) {
	$tab_upload_label = esc_html__( 'Upload Custom Icon', 'azrcrv-i' );
	$tab_upload       = '
