...
<div id="tabs" class="azrcrv-ui-tabs">
	...
	<ul class="azrcrv-ui-tabs-nav azrcrv-ui-widget-header" role="tablist">
		<li class="azrcrv-ui-state-default azrcrv-ui-state-active" aria-controls="tab-panel-icons" aria-labelledby="tab-icons" aria-selected="true" aria-expanded="true" role="tab">
			<?php // phpcs:ignore. ?>
			<a id="tab-icons" class="azrcrv-ui-tabs-anchor" href="#tab-panel-icons"><?php echo $tab_icons_label; ?></a>
		</li>
	...
	<div id="tab-panel-icons" class="azrcrv-ui-tabs-scroll" role="tabpanel" aria-hidden="false">
		<fieldset>
			<legend class='screen-reader-text'>
				<?php
				// phpcs:ignore.
				echo $tab_icons_label;
				?>
			</legend>
			<?php
			// phpcs:ignore.
	...
	<div id="tab-panel-upload" class="azrcrv-ui-tabs-scroll azrcrv-ui-tabs-hidden" role="tabpanel" aria-hidden="true">
		<fieldset>
			...
			<form method='post' action='admin-post.php' enctype='multipart/form-data'>
				<input type='hidden' name='action' value='<?php echo esc_attr( PLUGIN_UNDERSCORE ); ?>_upload_image' />
				<?php
				// phpcs:ignore.
				echo $tab_upload;
				?>
				<input type='hidden' name='which_button' value='upload_image' class='short-text' />
				<?php wp_nonce_field( PLUGIN_HYPHEN . '-image', PLUGIN_HYPHEN . '-image-nonce' ); ?>
...
<div class='azrcrv-donate'>
	...
	<span>
		<?php
		esc_html_e( 'You can help support the development of our free plugins by donating a small amount of money.', 'azrcrv-i' );
		?>
	</span>
</div>
